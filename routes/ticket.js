...
router
  ...
  .get(
    protect,
    authorizeMultiple("admin", "secretary"),
...
router
  .route("/tickets/event/:eventId/user/:userId")
  .get(
    protect,
    authorizeMultiple("admin", "secretary"),
    getTicketsByEventAndUser
...
router
  .route("/getTicketsByUser/user/:userId")
  .get(protect, authorizeMultiple("admin", "secretary"), getTicketsByUser);

router
  .route("/tickets/user/:userId")
  .get(protect, authorize("client"), getTicketsByUser);
